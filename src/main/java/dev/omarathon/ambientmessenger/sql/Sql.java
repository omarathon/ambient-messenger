...
public class Sql {
    ...
    public void createTableIfNotExist() throws SQLException {
        PreparedStatement statement = connection.prepareStatement(
                "CREATE TABLE IF NOT EXISTS " + table + " (" + SqlConstants.ID_FIELD + " MEDIUMINT NOT NULL AUTO_INCREMENT, " + SqlConstants.UUID_FIELD + " CHAR(36) NOT NULL, " + SqlConstants.MESSAGE_FIELD + " VARCHAR(65535) NOT NULL, " + SqlConstants.EXPIRY_FIELD + " TIMESTAMP NOT NULL)"
        );
        statement.execute();
    }
